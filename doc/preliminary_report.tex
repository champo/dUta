...
% Contra nginx para ver raw throughput
% Contra google para ver throughput con red de por medio
...
% Transformaciones con archivos grandes, chunked y multipart
\subsection{Transformaciones}

\subsubsection{Transfer-Encoding}
Ante una respuesta con \textit{Transfer-Encoding: chunked} una transformacion debe correctamente reconstruir el mensaje y luego aplicar la logica que corresponda.

\subsubsection{Cache Headers}
Podria ocurrir que el \os devuelva contenido con \textit{Cache headers} al que se aplica una transformacion en el proxy.
Luego, la transformacion es desactivada y el \ua vuelve a pedir este contenido con un \awesome{GET} condicional.
...
Este tipo de mensajes puede a su vez contener partes a las que apliquen transformaciones.
...
\subsection{Filtros}
% Filtro con multipart
% Browsing con filtros varios
% Contra un browser
