...
\section{Herramientas?}
    ...
    \begin{itemize}
        \item \awesome{Maven} Herramienta multiplataforma para el manejo de builds y depedencias
        \item \awesome{Eclipse} IDE para Java
        \item \awesome{PMD} Detecta potenciales problemas en codigo Java analizando el codigo fuente
        \item \awesome{FindBugs} Analsis estatico de aplicaciones Java
        ...
        \item \awesome{git} Sistema de control de versiones
        \item \awesome{8tracks} \emph{``Handcrafted internet radio''}
        \item \awesome{vim} \emph{``Highly configurable text editor built to enable efficient text editing''}
